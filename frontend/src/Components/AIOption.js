...
axios.get('http://127.0.0.1:5000/workspace/getlabels').then((response) => {
  ...
  console.log(isLoading)
    ...
    function squareHandler(event){
       ...
       let Annotation = ({"x":0,"y":0,"width":50,"height":50,"color":"red","label":selectedLabel})

        props.onSaveAnnotations(Annotation)
        setisDraw(true)
        // props.draw(Annotation)
