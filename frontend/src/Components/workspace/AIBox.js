...
return(
    <div class="ai-decisions-box">
        <div class="navigator">
            <button onClick={onFrameChangeBackwards}>backwards</button>
        ...
        <div>{frameCounter} out of {framesSize}</div>
            <button onClick={onFrameChangeForward}>front</button>
        ...
        {/* <p>{{ filename }}</p> */}
        <div>
            <button class="resuggest">Show Suggestions</button>
