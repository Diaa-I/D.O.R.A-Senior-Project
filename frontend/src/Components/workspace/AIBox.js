...
return(
    <div class="ai-decisions-box">
        <div class="navigator">
            <button onClick={props.onFrameChangeBackwards}>backwards</button>
        ...
        <div>{props.frameCounter} out of {props.framesSize}</div>
            <button onClick={props.onFrameChangeForward}>front</button>
        ...
        {/* <p>{{ filename }}</p> */}
        <div>
            <button class="resuggest" onClick={props.handleMakePrediction}>Show Suggestions</button>
